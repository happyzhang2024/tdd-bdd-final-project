...
class TestProductModel(unittest.TestCase):
    ...
    def test_find_by_price_with_string(self):
        """It should Find Products by Price using string"""
        product = ProductFactory(price=Decimal("19.95"))
        product.create()

        found = Product.find_by_price("19.95")
        self.assertGreater(found.count(), 0)
        self.assertEqual(found.first().price, Decimal("19.95"))

    def test_find_by_price_with_quoted_string(self):
        """It should Find Products by Price using quoted string"""
        product = ProductFactory(price=Decimal("29.95"))
        product.create()

        found = Product.find_by_price('"29.95"')
        self.assertGreater(found.count(), 0)
        self.assertEqual(found.first().price, Decimal("29.95"))
